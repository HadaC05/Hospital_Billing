        ...
        document.querySelectorAll('#admission-list tr').forEach(function (row) {
            ...
            if (columns.length > 0) {
                currentAdmissions.push({
                    patientName: columns[0].textContent,
                    contact: columns[1].textContent,
                    admissionDate: columns[2].textContent,
                    dischargeDate: columns[3].textContent,
                    reason: columns[4].textContent,
                    status: columns[5].textContent
                });
            }
        });
